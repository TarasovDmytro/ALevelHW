...
public class ApiController implements Initializable {
    ...
    private void loadRaceResult() {
        ...
        engine.load("http://localhost:8008/horse-race/race/" + race);
    }
    ...
    private void startRace() {
        ...
        engine.load("http://localhost:8008/horse-race/race/start?horses-total=" + totHorses + "&horse-number=" + horse);
    }

    public void loadStatisticOfRaces() {
        engine.load("http://localhost:8008/horse-race/stats");
    }
}